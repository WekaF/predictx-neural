  ...
  useEffect(() => {
    ...
    const runLoop = async () => {
        while (currentIndex < candles.length && !stopRef.current) {
            ...
            const signal = await analyzeMarketWithLocalML(currentSubset, indicators, trainingHist, [], symbol, strategy);
        ...
        <div className="flex justify-between items-center bg-slate-900/50 p-4 rounded-xl border border-slate-800">
            ...
            <div className="flex items-center gap-3">
                ...
                <button 
                    ...
                    className={`flex items-center gap-2 px-6 py-2 rounded-lg font-bold transition-all shadow-lg text-sm ${
                        isRunning 
