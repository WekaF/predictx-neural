...
import { X, Save, Globe, Zap, CheckCircle2, AlertTriangle, RefreshCcw, ShieldCheck, ArrowRightLeft, EyeOff, Info, Copy, Terminal } from 'lucide-react';
...
const SettingsModal: React.FC<SettingsModalProps> = ({ onClose }) => {
  ...
  const DEFAULT_URL = 'https://weka.app.n8n.cloud/webhook-test/b7252a1d-956c-4920-ad60-50daed75810e';
