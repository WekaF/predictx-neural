...
if result["status"] == "success":
    ...
    print(f"   Model saved to: models/predictx_v2.pth")
    print(f"   Scaler saved to: models/scaler_v2.pkl")
else:
...
print()
print("Models saved:")
print("  - models/predictx_v2.pth (LSTM)")
print("  - models/scaler_v2.pkl (Scaler)")
